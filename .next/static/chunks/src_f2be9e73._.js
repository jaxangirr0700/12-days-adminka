(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/src_f2be9e73._.js", {
...
function EditUser({ user, onCloseEdit, showDrawerEdit, open }) {
    ...
    const onFinish = (values)=>{
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].put(`https://nt.softly.uz/api/app/users/${user?.id}`, values, {
            headers: {
                Authorization: `Bearer ${MyAuthState.token}`
            }
        }).then((res)=>{
...
//# sourceMappingURL=src_f2be9e73._.js.map